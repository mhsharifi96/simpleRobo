...
class SimpleRobo:
    ...
    def __init__(self) -> None:
        ...
        self.allow_coins = ["BTC", "ETH", "LTC", "XRP", "BCH",
                            "BNB", "EOS", "XLM", "ETC", "TRX",
                            "PMN", "DOGE", "UNI", "DAI", "LINK",
                            "DOT", "AAVE", "ADA", "SHIB", "FTM",
                            "MATIC", "AXS", "MANA", "SAND", "AVAX",
                            "MKR", "GMT"]
        self.main_coin = "USDT"
        self.responses = {}
    ...
    def calc_profit(self, old_orders, new_order):
        ...
        for old_order in old_orders:
            last_trade_price_profit = \
                (float(new_order['last_trade_price'])-float(
                    old_order['last_trade_price']))/float(new_order['last_trade_price'])
    ...
    def choice_sell(self, calc_profit_responses, new_order):
        for id, profit in calc_profit_responses.items():
            if profit > self.tershold_1:
                ...
                self._api.update(update_id=id, key='report',
    ...
    def sell(self, coin):
        ...
        calc_profit_responses = self.calc_profit(
            old_orders=old_orders, new_order=new_order)
